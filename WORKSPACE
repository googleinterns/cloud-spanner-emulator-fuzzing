...
git_repository(
  ...
  remote = "https://github.com/GoogleCloudPlatform/cloud-spanner-emulator",
  branch = "master",
  patches = ["//patches:cloud_spanner_emulator.patch"]
)
...
http_archive(
    ...
    patches = ["@com_google_cloud_spanner_emulator//build/bazel:googleapis.patch"],
